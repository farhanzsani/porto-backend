...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Vellysia Dashboard') }}</title>
        ...
        <div class="relative bg-white p-6 dark:bg-gray-900 sm:p-0">
            <div class="relative flex h-screen w-full flex-col justify-center dark:bg-gray-900 sm:p-0 lg:flex-row">
                ...
                <div class="flex w-full flex-col lg:w-1/2">
                    <div class="mx-auto flex w-full max-w-md flex-col justify-center pt-10 flex-1">
                        <div>
                ...
                <div class="relative hidden h-full w-full items-center bg-brand-950 dark:bg-white/5 lg:grid lg:w-1/2">
                    <div class="z-1 flex items-center justify-center">
                        <div class="flex flex-col items-center max-w-xs">
                            <span class="mb-4 flex items-center gap-2 text-xl font-bold text-white">
                            ...
                            <p class="text-center text-gray-400 dark:text-white/60">
                                Manage your portfolio, projects, and inquiries from one place.
                            </p>
                        </div>
                    </div>
                </div>
